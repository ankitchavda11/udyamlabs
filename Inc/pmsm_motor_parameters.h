...
#define RS                     1.16 /* Stator resistance , ohm*/
#define LS                     0.000194 /* Stator inductance, H
...
#define NOMINAL_CURRENT         3027
#define MOTOR_MAX_SPEED_RPM     2820 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  2.6 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -3027 /*!< Demagnetization current */
